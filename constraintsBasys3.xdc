...
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {serial_clock_line[2]}];#Sch name = JB3
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {serial_data_line[3]}];#Sch name = JB4
